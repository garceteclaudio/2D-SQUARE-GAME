...
/// El movimiento es fluido, deberia moverse entre cuadrillallas ?
public class ScreenConCamaraCuadrado implements Screen {
    ...
    public ScreenConCamaraCuadrado(PrincipalScreen game) {
        this.game = game;
    }
